document.getElementById("submitBtn").addEventListener("click", (e) => {
    ...
    const Diabetic_complications = document.getElementById('Diabetic_complications').value;
    const Associated_Systemic_Problems = document.getElementById('Associated_Systemic_Problems').value;
    ...
    let clinical_attachment_levels_ = document.getElementsByClassName("clinical-attachment-levels");
    ...
    let probing_pocket_depth_ = document.getElementsByClassName("probing-pocket-depth");
    ...
    let clinical_attached_levels_ = document.getElementsByClassName("clinical-attached-levels");
